...
homekit_characteristic_t name = HOMEKIT_CHARACTERISTIC_(NAME, "BS53LOCK");
...
void user_init(void) {
        ...
        wifi_config_init("BS53LOCK", NULL, on_wifi_ready);
        gpio_init();
        lock_init();
        ...
        if (button_create(BUTTON_PIN_2, button_config, button_callback_2, NULL)) {
                printf("Failed to initialize button\n");
        }
